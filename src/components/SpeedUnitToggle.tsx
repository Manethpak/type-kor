...
const buttonClass = "cursor-pointer rounded-[5px] px-1.5 py-1 text-[8px] font-semibold uppercase tracking-[.08em] text-app-dim transition-colors hover:text-app-accent";
...
export function SpeedUnitToggle({
  ...
  return (
    <div className="flex gap-0.5 rounded-lg border border-app-line bg-app-raised p-[3px]" role="group" aria-label={label}>
